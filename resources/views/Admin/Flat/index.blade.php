<x-app-layout>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{Route('flat.create')}}" class="btn btn-success" style="margin-right: 0px; margin-bottom: 20px;">Добавить этаж</a>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">

                                <h4 class="card-title">Этаж</h4>
                                    ...
                                    @foreach($flats as $flat)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#myModal{{ $flat->id }}">Удалить</a>
                                            </td>
